...
class SiteController extends Controller {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate()) {
                ...
                if ($table->insert()) {
                    ...
                    $body .= "<a href='http://localhost/imaginamos/web/index.php?r=site/confirm&id=" . $id . "&authKey=" . $authKey . "'>Confirmar</a>";
    ...
    // Controlador para la actualizacion alumnos
    public function actionUpdate() {
        // LLamado para la validacion del formulario
    ...
    // Controlador para la elminiar alumnos
    public function actionDelete() {
        if (Yii::$app->request->post()) {
            $id_alumno = Html::encode($_POST["id_alumno"]);
            if ((int) $id_alumno) {
                //Eliminacion del registro sobre el modelo
    ...
    // Controlador para la lista de alumnos
    public function actionView() {
        // carga del modelo que valida la busqueda
        $form = new FormSearch;
        $search = null;
        if ($form->load(Yii::$app->request->get())) {
            // validacion del filtro
            if ($form->validate()) {
                // Busqueda de los alumnos con parametros de busqueda
                ...
                $count = clone $table;
                // paginacion se uso el modulo de YII
    ...
    // Controlador para la creacion de alumnos
    ...
    public function actionRequest() {
        ...
        if (isset($_REQUEST["nombre"])) {
            ...
            $mensaje = "has enviado tu nombre correctamente " . $nombre . "";
        }
